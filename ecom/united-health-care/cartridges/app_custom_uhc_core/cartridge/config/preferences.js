...
base.restrictedPracticeIDs = currentSite.getCustomPreferenceValue('restrictedPracticeIDs');
base.hsId_pfidpadapterid = currentSite.getCustomPreferenceValue('hsId_pfidpadapterid');
base.hsId_portal = currentSite.getCustomPreferenceValue('hsId_portal');
